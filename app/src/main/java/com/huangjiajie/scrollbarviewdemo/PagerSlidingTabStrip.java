...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = getContext().getResources().getColor(R.color.cardview_dark_background);
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* LogUtils.i("--width---" + width);
        lineLeft = (width - 100) / 2;
        lineRight=((width - 100) / 2)+100;*/
        ...
        float width = (lineRight+lineLeft)/2;
        float left=width-50;
